...
td:focus::before {
  ...
  z-index: -1;
    ...
    Batch
    <select id='batch' name='batch_display' onchange='insert_attendance()'>
    ...
    Program
    <select id='program' name='program_display' onchange='insert_attendance()'>
      <option value='0' selected disabled>(Select One)</option>
      <option value='1'>Transform - Regular</option>
      <option value='2'>Transform - Jumpstart Parents</option>
    ...
    &nbsp;&nbsp;
    Format
    <select id='format' onchange='insert_attendance()'>
      <option value='0' selected disabled>(Select One)</option>
...
function insert_attendance()
{
	...
	xmlhttp.open('GET', '_action.php?command=get_r2_report&batch='+batch+'&program='+program+'&format='+format, true);
