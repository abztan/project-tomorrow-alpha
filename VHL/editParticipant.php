<?php
	...
	if(isset($_POST['update']))
	{
		...
		else
		{
				...
				$address = "viewParticipantPsc.php?a=$entry_id&b=$participant_pk";
		}
	}
	...
	if(isset($_POST['esc']))	{
		header('location: /ICM/VHL/editParticipantPsc.php?a='.$entry_id.'&b='.$participant_pk);
	}
...
<fieldset>
	...
	<br/><br/><br/>
	<?php if($accesslevel == "1" || $accesslevel == "99")

	echo '<button class="btn btn-embossed btn-primary" name="delete">Delete</button> ';

	echo '<button class="btn btn-embossed btn-primary" name="drop">Drop</button> ';

	echo '<button class="btn btn-embossed btn-primary" name="esc">Edit Score Card</button> ';
	?>
