...
$_SESSION['currentpage']="listSelection.php";
...
$hidden1 = "yes";
	...
	if($accesslevel == "5")
	{
		$query1 = getListApplicationByBase_ByTag($_SESSION['baseid'], 3);
		$hidden = "yes";
	}
	...
	{
		if($selected_base == "0")
			$query1 = getListApplicationByTag(3);
		else
			$query1 = getListApplicationByBase_ByTag($selected_base, 3);
...
<section id="col1">
	...
	while($row=pg_fetch_array($result,NULL,PGSQL_BOTH))
	{
		...
		$application_type = getApplication_String($application_type);
		...
		echo "<td align='center'>".$i."/".countParticipantTotal($entry_id)."</td>
				  <td align='center'>
				    <a onClick=\"javascript: return confirm('Drop entry back to &lsquo;For Ocular Visit&lsquo;?');\" href='_applicationaction.php?a=4&b=".$row['id']."&c='>Drop</a>&nbsp;|&nbsp;
				    <a href='viewSelection.php?a=".$row['id']."'>Update</a></td></tr>";
		$count++;
	}
	?>
</section>
