...
if(isset($_POST['update']))
{
	...
	$graduated = $_POST['education_graduate'];
	$seminary = $_POST['seminary'];
	$province = $_POST['province'];
	$city = $_POST['city'];
	$barangay = $_POST['barangay'];
	$address = $_POST['pastor_address'];
	$contact_1 = $_POST['contact_1'];
	$contact_2 = $_POST['contact_2'];
	$contact_3 = $_POST['contact_3'];
	$email = $_POST['email'];
	$base_id = $_POST['base'];
	$district = $_POST['th_area'];
	$church_name = $_POST['c_name'];
	$denomination = $_POST['c_denomination'];
	$denom_spec = $_POST['c_specify'];
	$position = $_POST['c_position'];
	$church_province = $_POST['c_province'];
	$church_city = $_POST['c_city'];
	$church_barangay = $_POST['c_barangay'];
	$church_address = $_POST['c_address'];
	$is_planted = $_POST['c_planted'];
	$membership = $_POST['member'];
	$membership_date = $_POST['mdate'];


	//generate match name and duplicate
	updatePastorProfile($pastor_pk,$last_name,$first_name,$middle_name,$status,$gender,$bday
	,$education,$graduated,$seminary,$province,$city,$barangay,$address,$contact_1,$contact_2,$contact_3,$email,$base_id,$district,$position);
	updateChurchProfile($churchid,$church_name,$denomination,$denom_spec,$church_province,$church_city,$church_barangay,$church_address,$is_planted,$username);
	updatePastorMembership($pastor_pk, $membership, $membership_date, $username);
