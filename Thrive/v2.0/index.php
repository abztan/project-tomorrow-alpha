...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    ...
    <div class="mdl-layout__tab-bar mdl-js-ripple-effect">
      <a id="a_tab1" href="#tab-1" class="mdl-layout__tab is-active">Dashboard</a>
      <a id="a_tab2" href="#tab-2" class="mdl-layout__tab">Districts</a>
      <a id="a_tab3" href="#tab-3" class="mdl-layout__tab">+Profile</a>
      <a id="a_tab4" href="#tab-4" class="mdl-layout__tab">+Data Card</a>
      <a id="a_tab5" href="#tab-5" class="mdl-layout__tab">Search</a>
      <a id="a_tab6" href="#tab-6" class="mdl-layout__tab">Report</a>
    </div>
  </header>

  <div class="mdl-layout__drawer">
    <span style="font-size:14px;" class="mdl-layout-title"><img src="/ICM/_media/ic_person_black_48dp_1x.png"/><?php echo $username;?></span>
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="/ICM/logout.php">Logout</a>
    </nav>
  </div>
  ...
  <main class="mdl-layout__content">
    ...
    <section class="mdl-layout__tab-panel" id="tab-4">
      <div class="page-content" style="margin:0px;padding:0px;overflow:hidden">
				...
				<iframe src="attendance_form.php" frameborder="0" style="position: absolute; height: 100%; border: none"></iframe>
      </div>
    </section>
    ...
    <section class="mdl-layout__tab-panel" id="tab-6">
      <div class="page-content">
				<iframe src="r3.php" frameborder="0" style="position: absolute; height: 100%; border: none"></iframe>
      </div>
    </section>
  </main>
</div>
<script type="text/javascript">
	<?php
		if($access_level == "15") {
			echo 'document.getElementById("a_tab2").style.display = "none";';
			echo 'document.getElementById("a_tab3").style.display = "none";';
			echo 'document.getElementById("a_tab4").style.display = "none";';
			echo 'document.getElementById("a_tab6").style.display = "none";';
		}
	?>
</script>
