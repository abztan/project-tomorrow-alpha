...
if(isset($_POST['back'])) {
	header('Location:district_view.php?a='.$district_pk);
}
?>
...
<body>
	...
	<div class="mdl-grid">
		...
		<a href="editPastor.php?a=<?php echo $pastor_pk;?>" class="mdl-button mdl-js-button mdl-button--icon mdl-button--colored" title="Edit"><i class="material-icons">mode_edit</i></a>
		<div onClick="deleteProfile(<?php echo $pastor_pk;?>)" class="mdl-button mdl-js-button mdl-button--icon mdl-button--colored" title="Delete"><i class="material-icons">delete</i></div>
		</div>
	</div>
	<div class="mdl-grid">
	  <div class="mdl-cell mdl-cell--6-col mdl-shadow--2dp" style="background:#E7E4DF;">
		  <div id="title">Personal Information<span><?php if($member=="Yes") { echo '<img align="right" src="/ICM/_media/star1.png">'; }?></span></div>
		  <table>
	...
	<div class="mdl-grid" >
	  <div class="mdl-cell mdl-cell--6-col mdl-shadow--2dp" style="background:#E7E4DF;">
			<div id="title">Pastoral Information</div>
		  <table>
...
function deleteProfile(a) {
	var r = confirm("Delete this profile?");
	if (r == true) {
			var username = "<?php echo $username;?>";
			window.location="_action.php?command=delete_profile&username="+username+"&pastor_pk="+a+"&from=profile";
	}
}
</script>
