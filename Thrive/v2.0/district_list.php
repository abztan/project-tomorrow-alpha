...
<br/>
<div class="mdl-grid mdl-cell--3-col mdl-cell--stretch mdl-cell--middle" style="background:#E0E0E0;">
	<span id="label_style">Display Base</span>
	<?php if($is_hidden == "no")
	echo "<select style='width:automatic;' class='mdl-select__input' name='base_display' onchange='form.submit()'>
...
<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp" align="center" width="50%" style="background:#FAFAFA;">
	<thead>
		<tr>
			<th class="mdl-data-table__cell--non-numeric"><a href="district_list.php?a=district_id&b=<?php echo $selected_base;?>">ID</a></th>
		...
		<?php
			...
			while($row=pg_fetch_array($result,NULL,PGSQL_BOTH))
			{
				...
				echo "<tr>
						  ...
						  <td>$population</td>
						  <td><a href='district_view.php?a=$district_id'>View</a></td>
							</tr>";
			}
		?>
	</tbody>
