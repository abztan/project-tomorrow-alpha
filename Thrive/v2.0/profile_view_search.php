...
<head>
	...
	<title>Profile: <?php echo $pastor_pk_string;?></title>
...
<body>
	...
	<div class="mdl-grid">
	  <div class="mdl-cell mdl-cell--5-col mdl-shadow--2dp" style="background:#E7E4DF;">
...
function deleteProfile(a) {
	...
	if (r == true) {
			...
			window.location="_action.php?command=delete_profile&username="+username+"&pastor_pk="+a+"&from=search";
	}
}
</script>
</html>
