...
<section id="col1">
	<table border = "1">
	<th style="border-top: 1px solid #F7F7F7;border-right: 1px solid #F7F7F7;border-left: 1px solid #F7F7F7;" colspan = "4" align = "left">Pastor Data Overview</th>
	...
	<tr align = "center">
		...
		<td style="border-bottom: 1px solid #F7F7F7;"><div id="text_style1">UPDATES</div></td>
	</tr>
	...
	<tr align = "center">
		...
		<td rowspan = "2">
		<h1><?php $year = date("Y"); $current_month = date("m"); $dateObj = DateTime::createFromFormat('!m', $current_month); echo $dateObj->format('F');?></h1>
		Profiles Added: <?php echo countProfiles_byMonth('0', $current_month, $year);?>
		<br/>Members Added: <?php echo countMembers_byMonth('0', $current_month, $year);?>
		<h1><?php $last_month = date("m")-1; $dateObj = DateTime::createFromFormat('!m', $last_month); echo $dateObj->format('F');?></h1>
		Profiles Added: <?php echo countProfiles_byMonth('0', $last_month, $year);?>
		<br/>Members Added: <?php echo countMembers_byMonth('0', $last_month, $year);?>
		<h1><?php $last_2_month = date("m")-2; $dateObj = DateTime::createFromFormat('!m', $last_2_month); echo $dateObj->format('F');?></h1>
		Profiles Added: <?php echo countProfiles_byMonth('0', $last_2_month, $year);?>
		<br/>Members Added: <?php echo countMembers_byMonth('0', $last_2_month, $year);?>
	...
	<table >
		<tr>
			<th>Base</th>
			<th>Added Profiles</th>
			<th>Added Members</th>
			<th>Deleted Profiles</th>
		</tr>
		<?php
 		for($i=1;$i<11;$i++)
			echo "<tr>
						<td>".getBaseName($i)."</td>
						<td align='right'>".countProfiles_byMonth($i, $current_month, $year)."</td>
						<td align='right'>".countMembers_byMonth($i, $current_month, $year)."</td>
						<td align='right'>".countProfiles_byTag($i, 0)."</td>
					</tr>";
		?>
	</table>
	<br/>
