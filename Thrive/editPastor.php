...
if(empty($_SESSION['username']))
	...
	if($churchid != "") {
		...
		if(isset($_POST['update']))
		{
			...
			header('location: viewPastor.php?a='.$pid.'');
		}
...
<legend>Church Information</legend>
	...
	<!--<label>Last Sunday Attendance</label><br/>
	  <input class="form-control input-sm" placeholder="Adults" type="text" name="c_adult">
	  <input class="form-control input-sm" placeholder="Kids" type="text" name="c_child">
	<br/>

	<label>Access To</label><br/>
	<select name="c_medical">
	<option disabled selected>Medical Services?</option>
	<option value='Yes'>Yes</option>
	<option value='No'>No</option>
	</select>
	<select name='c_water'>
	<option disabled selected>Clean Water?</option>
	<option value='Yes'>Yes</option>
	<option value='No'>No</option>
	</select>
	<select name='c_market'>
	<option disabled selected>Market/Stores?</option>
	<option value='Yes'>Yes</option>
	<option value='No'>No</option>
	</select>
	<select name='c_electricity'>
